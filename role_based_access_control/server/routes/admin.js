...
router.get("/sessions", authenticateToken,authorizeRoles('super_admin','admin'),async (req, res) => {
  try {
...
router.get("/detailed_sessions/:sessionId",authenticateToken,authorizeRoles('super_admin','admin'),async (req, res) => {
...
router.get("/sessions/:sessionId", authenticateToken,authorizeRoles('super_admin','admin'), async (req, res) => {
...
// for the admin to manage child accounnts 
  ...
  router.get("/verified/:username",authenticateToken,authorizeRoles('super_admin','admin'),async (req, res) => {
...
router.post("/add-child/:username",authenticateToken,authorizeRoles('super_admin','admin'),async (req, res) => {
  const { username } = req.params;
  const admin_email = username;
